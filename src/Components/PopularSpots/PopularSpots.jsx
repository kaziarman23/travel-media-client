...
const PopularSpots = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Set initial states
      gsap.set(
        [titleRef.current, descriptionRef.current, scrollIndicatorRef.current],
        {
          opacity: 0,
          y: 60,
          scale: 0.9,
      ...
      tl.to(backgroundRef.current, {
        background:
          "linear-gradient(135deg, rgba(0, 0, 0, 0.95) 0%, rgba(20, 30, 48, 0.8) 50%, rgba(36, 59, 85, 0.9) 100%)",
        duration: 2,
        ease: "power2.out",
      })
        // Globe animation
  ...
  return (
    <section ref={sectionRef} className="relative w-full min-h-screen">
          ...
          >
            ...
            <div className="flex justify-center items-center">
              ...
              >
                ...
                <div className="relative w-full h-full bg-gray-900/50 border border-gray-700 rounded-full backdrop-blur-sm overflow-hidden">
                  ...
                  <div
                    className="absolute inset-8 border border-purple-400/20 rounded-full animate-pulse"
            ...
            <div className="space-y-8 text-white">
              <div>
                ...
                >
                  We&#39;re passionate about turning your travel dreams into
                  reality. Whether you&#39;re seeking a tranquil getaway, a
                  thrilling adventure, or a cultural deep dive, our expert team
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              From pristine beaches to bustling city escapes, we connect you
              with the world&#39;s most iconic destinations and hidden gems.
      ...
      <div
        className="absolute top-3/4 right-16 w-3 h-3 bg-purple-500/30 rounded-full animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute bottom-1/4 left-1/4 w-2 h-2 bg-green-500/30 rounded-full animate-pulse"
