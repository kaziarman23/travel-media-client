...
const TouristSpot = () => {
  ...
  if (isLoading || loading) {
    return <Loader>Loading All Spot Data</Loader>;
  }

  if (isError) {
    console.log("Error when fetching all spots data: ", error);
    return (
  ...
  const stats = [
    {
      icon: FaDollarSign,
      label: "Average Cost",
      value: spotData.average_cost,
      color: "text-green-400",
    },
    {
      icon: FaUsers,
      label: "Annual Visitors",
      value: spotData.totalVisitorsPerYear || "500K+",
      color: "text-blue-400",
    },
    {
      icon: FaClock,
      label: "Travel Time",
      value: spotData.travel_time,
      color: "text-purple-400",
    },
    {
      icon: FaSun,
      label: "Best Season",
      value: spotData.seasonality,
  ...
  const images = [spotData.image, spotData.image, spotData.image];
  ...
  return (
    <section className="relative w-full min-h-screen bg-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-center space-x-4 mb-6">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="text-gray-300 ml-2">
                ({(spotData.rating || 4.5).toFixed(1)}/5)
              </span>
            </div>
          </div>
        ...
        {/* Main Content */}
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 transition-all duration-1000 delay-300 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          {/* Image Gallery */}
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <stat.icon
                      className={`text-2xl ${stat.color} animate-pulse`}
                    />
                    <div>
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed">
                      {spotData.description ||
                        `Discover the breathtaking beauty of ${spotData.spot}, located in ${spotData.country}. This magnificent destination offers an unforgettable experience for travelers seeking adventure, culture, and natural beauty. With its stunning landscapes and rich heritage, ${spotData.spot} promises memories that will last a lifetime.`}
                    </p>
                  </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors duration-200">
                        ...
                        <div>
                          ...
                          <div className="text-sm">
                            {spotData.totalVisitorsPerYear || "500,000+"}
                          </div>
                        </div>
                      </div>
                ...
                <div className="space-y-6 animate-fade-in">
                  <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-lg p-6 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300">
                    ...
                    <p className="text-gray-300 mb-6">
                      Book your trip to {spotData.spot} now and experience the
                      adventure of a lifetime. Our professional team will ensure
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      ...
                      <div className="text-center p-4 bg-gray-900/50 border border-gray-700 rounded-lg hover:border-green-500 hover:scale-105 transition-all duration-300">
                        <FaHotel
                          className="text-2xl text-green-400 mx-auto mb-2 animate-bounce"
                      ...
                      <div className="text-center p-4 bg-gray-900/50 border border-gray-700 rounded-lg hover:border-purple-500 hover:scale-105 transition-all duration-300">
                        <FaCar
                          className="text-2xl text-purple-400 mx-auto mb-2 animate-bounce"
