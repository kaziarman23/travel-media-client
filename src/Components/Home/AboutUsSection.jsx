  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(backgroundRef.current, {
        background:
          "radial-gradient(circle at 70% 30%, rgba(59, 130, 246, 0.08) 0%, rgba(147, 51, 234, 0.04) 50%, transparent 100%)",
        duration: 1.5,
        ease: "power2.out",
      })
        // Title animation
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Carousel Section */}
          <div ref={carouselRef} className="relative order-2 lg:order-1">
          ...
          <div ref={contentRef} className="space-y-8 order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-400 leading-relaxed">
                ...
                digital creators, dedicated to inspiring your next adventure.
                Our platform was founded with one simple goal: to help travelers
                discover the beauty of the world, one destination at a time.
              </p>

              <p className="text-gray-500 leading-relaxed">
                Whether you&#39;re looking for off-the-beaten-path journeys or
                well-loved landmarks, our mission is to provide insightful and
